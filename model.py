...
def define_cnn(features=None, hparams=None):
  ...
  with slim.arg_scope([slim.conv2d],
    ...
    net = slim.conv2d(net, 64, kernel_size=[11, 11])
    print("1",net)
    net = tf.nn.relu(net)
    ...
    net = slim.conv2d(net, 128, kernel_size=[9, 9])
    print("3",net)
    ...
    net = slim.conv2d(net, 256, kernel_size=[7, 7])
    print("5",net)
    net = tf.nn.relu(net)
    ...
    net = slim.conv2d(net, 512, kernel_size=[5, 5])
    print("7",net)
    net = tf.nn.relu(net)
