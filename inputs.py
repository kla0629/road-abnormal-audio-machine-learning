...
def clip_to_log_mel_examples(clip, clip_dir=None, hparams=None):
  ...
  print("magnitude_spectrogram" , magnitude_spectrogram)
  ...
  print("log_mel_spcetrogram", log_mel_spectrogram)
  ...
  print("example_window_length_samples",example_window_length_samples)
  example_hop_length_samples = int(round(spectrogram_sr * hparams.example_hop_seconds))
  print("example_hop_length_samples",example_hop_length_samples)
  features = tf.contrib.signal.frame(
      signal=log_mel_spectrogram,
      frame_length=example_hop_length_samples,
